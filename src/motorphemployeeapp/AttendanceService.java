 ...
 *
 * Responsibilities:
 *   - Calculate total hours worked for an employee over a date range
 *   - Calculate payable hours for a single day (applying grace period,
 *     overtime cap, and lunch-break deduction)
 */
public class AttendanceService {
     ...
     *
     * @param empNum     Employee number to filter attendance rows.
     * @param startDate  Cutoff start date in "MM/dd/yyyy" format.
     * @param endDate    Cutoff end date in "MM/dd/yyyy" format.
     * @return           Total payable hours as a double.
     * @throws Exception If date or time parsing fails.
     */
     ...
     *
     * @param login   Recorded login time.
     * @param logout  Recorded logout time.
     * @return        Payable hours (≥ 0) for this single day.
     */
