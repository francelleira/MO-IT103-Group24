 ...
 *
 * This class knows nothing about business logic or CSV data — its
 * only job is to assemble the window and make it visible.
 *
 * Responsibilities:
 *   - Create and configure the JFrame
 *   - Build the CardLayout container
 *   - Add all panels under their named card keys
 *   - Show the login card as the initial view
 */
public class MainFrame {
     ...
     * and makes it visible. Must be called on the Event Dispatch Thread.
     */
