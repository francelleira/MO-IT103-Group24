 ...
 *
 * Responsibilities:
 *   - Render the branded login card
 *   - Handle the Sign In action (button click and Enter-key press)
 *   - Validate that neither field is empty
 *   - Authenticate against the two known credential pairs
 *   - Display inline error messages without modal dialogs
 */
public class LoginPanel {
     ...
     *
     * @param layout  The CardLayout used by MainFrame.
     * @param cards   The container managed by the CardLayout.
     * @return        Ready-to-display Login panel.
     */
